...
public interface CourseRepository extends JpaRepository <Course, String> {
    ...
    Course findCourseByClassNameAndProfessorName(@Param("className")String className, @Param("professorFirstName")String professorFirstName, @Param("professorLastName")String professorLastName);
